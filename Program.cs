...
class MyStack<T> {
   ...
   /// <summary> Property with top variable </summary>
   public int Top => mTop;
   ...
   /// <summary> IsEmpty property to check whether the stack is empty </summary>
   public bool IsEmpty => (mTop == -1) ? true : false;
