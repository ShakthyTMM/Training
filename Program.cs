...
class TQueue<T> {
   ...
   /// <summary> Property with front of the queue </summary>
   public int Front => mFront;

   /// <summary> Property with rear of the queue </summary>
   public int Rear => mRear;
   ...
   public bool IsEmpty => (mFront > mRear) ? true : false;
